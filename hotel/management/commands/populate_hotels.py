...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        hotels = [
            ...
            {"name": "Lakeside Lodge", "price": 85.00, "location": "Montreal", "availability": True},
            ...
            {"name": "Cambridge Suites Hotel", "price": 128.00, "location": "Halifax", "availability": True},
            {"name": "Prince George Hotel", "price": 180.00, "location": "Halifax", "availability": True},
            ...
            {"name": "Future Inns Halifax", "price": 118.00, "location": "Halifax", "availability": True},
            ...
            {"name": "Chebucto Inn", "price": 170.00, "location": "Halifax", "availability": True},
            {"name": "Commons Inn", "price": 141.00, "location": "Halifax", "availability": True},
            {"name": "The Hollis Halifax a DoubleTree Suites by Hilton Hotel", "price": 173.00, "location": "Halifax", "availability": True},
            ...
            {"name": "Holiday Inn Express & Suites Halifax - Bedford", "price": 100.00, "location": "Halifax", "availability": True},
            ...
            {"name": "Sandman Signature Dartmouth Hotel & Suites", "price": 139.00, "location": "Dartmouth", "availability": True},
            ...
            {"name": "Brigantine Inn & Suites", "price": 110.00, "location": "Lunenburg", "availability": True},
            ...
            {"name": "Courtyard by Marriott Halifax Dartmouth", "price": 130.00, "location": "Dartmouth", "availability": True},
            {"name": "Delta Hotels by Marriott Dartmouth", "price": 160.00, "location": "Dartmouth", "availability": True},
            {"name": "Lake City Motel", "price": 70.00, "location": "Dartmouth", "availability": True},
            ...
            {"name": "The Tidal Bore Inn", "price": 90.00, "location": "Maitland", "availability": True},
        ]
